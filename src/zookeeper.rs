...
impl ZooKeeper {
    ...
    pub fn exists_w<W: FnOnce(&WatchedEvent) + Send + 'static>(&self,
                                                               path: &str,
                                                               watcher: W)
                                                               -> ZkResult<Stat> {
        let req = ExistsRequest {
    ...
    pub fn get_children_w<W: FnOnce(&WatchedEvent) + Send + 'static>(&self,
                                                                     path: &str,
                                                                     watcher: W)
                                                                     -> ZkResult<Vec<String>> {
    ...
    pub fn get_data_w<W: FnOnce(&WatchedEvent) + Send + 'static>(&self,
                                                                 path: &str,
                                                                 watcher: W)
